...
//		char b =''; //에러
		...
		char b_3 = 'a'; // 1개문자만가능
//		char b_4 = 'ab';//2개이상 안됨
		char b_5 = 97; // 아스키코드 a 가나옴 97:a 65:A 48:'0'
		char b_6 = 42; // 아스키코드 * 가나옴
		char b_7 = 52; // 문자 '4'
		int b_8 = b_7 - 48; // '4'-'0' =4

		byte c = (byte) (127 + 1); // 127까지 -> -128 오버플로우 발생
		// byte,short,char->사칙연산-> int타입으로 변경되어 계산

		int d = 2147483647;// 약 21억까지 숫자계산가능
		int d_2 = (int) (2147483648L);
		int d_3 = 1000000;
		int d_4 = 1000000 * 1000000 / 1000000;
		int d_5 = 1000000 / 1000000 * 1000000;
		long e = 1L; // 약 900경 까지 숫자계산가능
		long e_2 = 2l; // 소문자도가능
		// byte ,short, int, long

		float f = 1.0f; // 접미사 f,F를 무조건 붙여야함.
		...
		double g_3 = 1.1234567890123456789;// 소수점 16자리까지 유효성인정
		...
		int s_9 =Integer.parseInt(s_7); //문자열 -> int 타입변경
		double s_10 = Double.parseDouble(s_8); //문자열 ->double 타입변경 //중요 

		//문자열에서 1개 문자를 분리 
		String s_11 ="홍길동";    
		char s_12 = s_11.charAt(0);  //중요 
