...
//		
//		Student s3 =null;
//		s3= s1;//주소값만복사 s1,s3같은 공간을 바라봄. -얕은복사  
//		
//		
		...
		//hashcode 데이터수정이 되었는지 확인 할때 ,암호화 설정할때 
		//다량의 데이터를 저장 &검색하는 해싱기법 
//	    String str1 ="1111";
//	    String str2 ="abcd";
...
//				+ " \r\n"
//				+ "백악관 고위 관계자는 AP통신에 \"국가별 세부 관세율 조정에 시간이 필요해 당초 예정됐던 1일보다 늦은 7일부터 관세를 적용하게 됐다\"고 밝혔다.");
////		String str2 =new String("aaaaabbbbbcccc");
...
//		Person p1 =new Person();
//		p1.id=199905051111111L;
//		p1.name="홍길동";
//		p1.address="서울";
//		Person p2 =new Person(199905051111111L,"홍길동","서울");
//		//equals String만 예외로된거임 
//		if(p1.equals(p2)) {
//			System.out.println("같다");
//		}else {
//			System.out.println("다르다");
...
//			}
//		
//		if(str1.equals(str2)) {//객체변수 , 참조변수는 등가비교 안됨.  //equals로 Object클래스상속받아서사용하는거임. 
//			System.out.println("같다");
//		}else {
//			System.out.println("다르다");
//			}
